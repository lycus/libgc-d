...
extern (C)
{
    ...
    void GC_exclude_static_roots(void* low_address, void* high_address_plus_1);
    void GC_clear_roots();
    void GC_add_roots(void* low_address, void* high_address_plus_1);
    void GC_remove_roots(void* low_address, void* high_address_plus_1);
    ...
    void GC_register_finalizer(void* obj, gc_finalization_proc_fun fn, void* cd, gc_finalization_proc_fun* ofn, void** ocd);
    void GC_register_finalizer_ignore_self(void* obj, gc_finalization_proc_fun fn, void* cd, gc_finalization_proc_fun* ofn, void** ocd);
    void GC_register_finalizer_no_order(void* obj, gc_finalization_proc_fun fn, void* cd, gc_finalization_proc_fun* ofn, void** ocd);
    void GC_register_finalizer_unreachable(void* obj, gc_finalization_proc_fun fn, void* cd, gc_finalization_proc_fun* ofn, void** ocd);
    ...
    void* GC_call_with_alloc_lock(gc_fn_type_fun fn, void* client_data);
    void* GC_call_with_stack_base(gc_stack_base_func_fun fn, void* arg);
